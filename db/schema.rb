...
ActiveRecord::Schema[7.2].define(version: 2026_07_28_132229) do
  ...
  create_table "races", force: :cascade do |t|
    ...
    t.index ["cancelled"], name: "index_races_on_cancelled"
  ...
  create_table "reactions", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["reactable_type", "reactable_id", "kind"], name: "idx_reactions_by_target_kind"
    t.index ["reactable_type", "reactable_id"], name: "index_reactions_on_reactable"
    t.index ["user_id", "reactable_type", "reactable_id", "kind"], name: "idx_reactions_unique_per_user_target_kind", unique: true
